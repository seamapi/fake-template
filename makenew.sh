...
makenew () {
  ...
  find_replace "s/Fake Template/${mk_title}/g"
  find_replace "s/Package skeleton for a fake\./${mk_description}/g"
  find_replace "s/@seambot/@${mk_codeowner}/g"
  find_replace "s|@seamapi/fake-template|${mk_slug}|g"
  find_replace "s|fake-template|${mk_repo}|g"
